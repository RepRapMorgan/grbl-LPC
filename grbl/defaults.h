...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  // Description: MCNC mill with three 200 step/rev motors driven by MKS
  // grblShield at 12V.
  #define DEFAULT_X_STEPS_PER_MM 304.91217
  #define DEFAULT_Y_STEPS_PER_MM 300.16675
  #define DEFAULT_Z_STEPS_PER_MM 5000.00000
  #define DEFAULT_A_STEPS_PER_MM 160.0
  #define DEFAULT_X_MAX_RATE 500.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 500.0 // mm/min
  #define DEFAULT_Z_MAX_RATE 5.0 // mm/min
  #define DEFAULT_A_MAX_RATE 500.0 // mm/min
  #define DEFAULT_X_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Y_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
  #define DEFAULT_Z_ACCELERATION (10.0*60*60) // 10*60*60 mm/min^2 = 10 mm/sec^2
