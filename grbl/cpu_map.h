...
#define cpu_map_h
...
#ifdef CPU_MAP_SPEEDYBOARD // (Speedyboards)
  ...
  // Primary pin      P1.18     P1.20     P1.21     P1.23     P1.24     P1.26
  // Secondary pin    P2.0      P2.1      P2.2      P2.3      P2.4      P2.5
  #define SPINDLE_PWM_CHANNEL           PWM1_CH5    // BIG MOSFET Q6 (P2.5)
...
#ifdef CPU_MAP_MKS_SBASE_MLASER // (MKS SBASE Boards)
...
#ifdef CPU_MAP_MKS_SBASE_MCNC // (MKS SBASE Boards)
  ...
  #define A_LIMIT_BIT       28  // reuse p1.29
  #define LIMIT_MASK       ((1<<X_LIMIT_BIT)|(1<<Y_LIMIT_BIT)|(1<<Z_LIMIT_BIT)) // All limit bits
  ...
  // Define user-control controls (cycle start, reset, feed hold) input pins.
  // NOTE: All CONTROLs pins must be on the same port and not on a port with other input pins (limits).
  #define CONTROL_DDR       LPC_GPIO3->FIODIR
  #define CONTROL_PIN       LPC_GPIO3->FIOPIN
  #define CONTROL_PORT      LPC_GPIO3->FIOPIN
  #define CONTROL_RESET_BIT         0  // Uno Analog Pin 0
  #define CONTROL_FEED_HOLD_BIT     25  // Uno Analog Pin 1
  #define CONTROL_CYCLE_START_BIT   26  // Uno Analog Pin 2
  #define CONTROL_SAFETY_DOOR_BIT   1  // Uno Analog Pin 1 NOTE: Safety door is shared with feed hold. Enabled by config define.
  #define CONTROL_INT       PCIE1  // Pin change interrupt enable pin
  #define CONTROL_INT_vect  PCINT1_vect
  #define CONTROL_PCMSK     NotUsed // Pin change interrupt register
